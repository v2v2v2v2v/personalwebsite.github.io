...
### Plot A = Scatter Plot for Precipitation in NYC
...
### Plot B = Bar Plot for Year Wise Total Precipitation
...
### Plot C = Plot Comparing Snow and Snow Depth
...
line_plot <- nydat1 |>
  ...
  labs(y = "Snow Depth (SNWD)", x = "Snow", title = "Relationship between snow fall and depth")
ggplotly(line_plot)
```