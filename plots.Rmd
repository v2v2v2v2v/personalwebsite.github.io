...
### Plot A = Scatter Plot for Precipitation
...
### Plot C = Plot Comparing Snowfall and Snow Depth
...
line_plot <- nydat1 |>
  ...
  labs(y = "Snow Depth (SNWD)", x = "Snow", title = "Relationship between snowfall and depth")
ggplotly(line_plot)
```